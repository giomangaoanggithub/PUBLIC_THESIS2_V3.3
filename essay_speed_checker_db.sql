...
(1, 'What happened to the story of the three little pigs?', '2023-02-12 06:23:44', NULL, 'englishteacher@gmail.com', '2', 0, '<!@#INCORRECT$%^><!@#CORRECT$%^>'),
(3, 'Is distance the same as displacement? Explain Why?', '2023-02-12 06:23:44', NULL, 'scienceteacher@gmail.com', '1', 0, '<!@#INCORRECT$%^><!@#CORRECT$%^>'),
(4, 'Which house that hasn\'t blown off by the big bad wolf?', '2023-02-12 06:23:44', NULL, 'englishteacher@gmail.com', '2', 0, '<!@#INCORRECT$%^><!@#CORRECT$%^>'),
(5, 'yolo', '2023-02-12 13:29:16', '2023-02-20 09:33:08', 'gioteacher@gmail.com', '3', 1, '<!@#INCORRECT$%^><!@#CORRECT$%^>'),
(6, 'yolo doggo', '2023-02-12 14:20:44', '0000-00-00 00:00:00', 'gioteacher@gmail.com', '4', 0, '<!@#INCORRECT$%^><!@#CORRECT$%^>'),
(29, 'eee', '2023-02-20 22:22:21', '0000-00-00 00:00:00', 'gioteacher@gmail.com', '', 0, '<!@#INCORRECT$%^><!@#CORRECT$%^>'),
(30, 'finally', '2023-02-20 22:46:34', '0000-00-00 00:00:00', 'gioteacher@gmail.com', '3', 1, '<!@#INCORRECT$%^><!@#CORRECT$%^>'),
(31, 'lol', '2023-02-20 22:56:54', '0000-00-00 00:00:00', 'gioteacher@gmail.com', '3', 0, '<!@#INCORRECT$%^><!@#CORRECT$%^>'),
(32, 'testing123', '2023-02-20 23:20:00', '2023-02-20 16:19:08', 'gioteacher@gmail.com', '3', 0, '<!@#INCORRECT$%^><!@#CORRECT$%^>'),
(64, 'This is a simulated question.', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'gioteacher@gmail.com', '3', 0, '<&*>inc sample<&*>inc sample<&*>inc sample<&*>Speed  alludes  to  an  question  travel  remove  over  time,  <!@#CORRECT$%^><&*>cor sample<&*>cor sample<&*>cor sample<&*>Speed  and  distance  are  scalar  quantities,  in  other  words,  they  only  consider  size,  while  speed  and  displacement  are  vector  quantities,  which  consider  not  only  size  but  also  direction  of  the  object.  <&*>whereas  speed  is  essentially  speed  with  an  consideration  of  heading  or  known  as  a  vector.  As  for  the  remove  and  uprooting,  both  are  comparable,  but  the  center  distinction  is  that  the  separate  tells  how  much  ground  an  question  has  secured,  whereas  uprooting  appears  how  distant  out  of  put  an  protest  is.  ');
...
(231, 'Speed is the distance traveled by an object over time, whereas velocity is speed plus direction, also known as a vector. Distance and displacement are similar, but the main difference is that distance indicates how much ground an object has covered, whereas displacement indicates how far out ', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
...
(238, 'Speed and Distance are scalar quantity in other words it only considers the magnitude, while Velocity and Displacement is a vector quantity which not only considers the magnitude, but also the direction of the object.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
(239, 'Speed talks about how fast and velocity also fast but with a sense of route. Distance and Displacement may look the same if we only calculate one line, but with more multiple lines we can easily differ displacement from distance.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
(240, 'If the object heads only from point A to point B without any form of direction then it is scalar value, but if the object has some direction, then it is considered a vector value.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
...
(246, 'Speed and Distance are scalar quantity in other words it only considers the magnitude, while Velocity and Displacement is a vector quantity which not only considers the magnitude, but also the direction of the object.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
...
(252, 'Speed alludes to an question travel remove over time, whereas speed is essentially speed with an consideration of heading or known as a vector. As for the remove and uprooting, both are comparable, but the center distinction is that the separate tells how much ground an question has secured, whereas uprooting appears how distant out of put an protest is.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
(253, 'Speed and Remove are scalar amount in other words it as it were considers the greatness, whereas Speed and Uprooting may be a vector amount which not as it were considers the greatness, but moreover the course of the question.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
(254, 'Speed and Distance are scalar amount in different phrases it handiest considers the magnitude, even as Velocity and Displacement is a vector amount which now no longer handiest considers the magnitude, however additionally the course of the object.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
(255, 'Speed and Distance are scalar amount in different words it solely considers the magnitude, whereas rate and Displacement could be a vector quantity that not only considers the magnitude, however conjointly the direction of the object.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
(256, 'Speed and distance are scalar quantities, in other words, they only consider size, while speed and displacement are vector quantities, which consider not only size but also direction of the object.', 64, 'bot', '2023-02-22 16:09:15', 0, 1),
...
(259, 'Speed alludes to an question travel remove over time, whereas speed is essentially speed with an consideration of heading or known as a vector. As for the remove and uprooting, both are comparable, but the center distinction is that the separate tells how much ground an question has secured, whereas uprooting appears how distant out of put an protest is.', 64, 'bot', '2023-02-22 16:09:15', 0, 1),
(260, 'Speed and Remove are scalar amount in other words it as it were considers the greatness, whereas Speed and Uprooting may be a vector amount which not as it were considers the greatness, but moreover the course of the question.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
(261, 'The ancient Greeks called cake πλακοῦς (plakous), which was derived from the word for \"flat\", πλακόεις (plakoeis). It was baked using flour mixed with eggs, milk, nuts, and honey. They also had a cake called \"satura\", which was a flat heavy cake. During the Roman period, the name for cake became \"placenta\" which was derived from the Greek term. A placenta was baked on a pastry base or inside a pastry case.', 64, 'bot', '2023-02-22 16:09:15', 0, 0),
(262, 'American teenager Peter Parker, a poor sickly orphan, is bitten by a radioactive spider. As a result of the bite, he gains superhuman strength, speed, and agility, along with the ability to cling to walls, turning him into Spider-Man. Parker also acquired a precognitive “spidey-sense” that alerted him to approaching dangers.', 64, 'bot', '2023-02-22 16:09:16', 0, 0),
(263, 'When The Flash reaches his destination, he can activate the skill again to return to where he started, dealing magic damage. Enemies damaged by the initial dash are dealt an additional magic damage. Shortly after settling back in Titans Tower, Bart reveals to Conner that during his brief stay in the future, he went through a number of records and schematics concerning technology from the era.', 64, 'bot', '2023-02-22 16:09:16', 0, 0),
(264, 'A dissertation tesis doctoral, with an average of 250 pages, is the main requisite along with typically one previously published journal article. Once candidates have published their written dissertations, they will be evaluated by two external academics evaluadores externos and subsequently it is usually exhibited publicly for fifteen natural days.', 64, 'bot', '2023-02-22 16:09:16', 0, 0),
(265, 'Glory to God in the highest And on earth, peace to people of good will We praise You We bless You We adore You We glorify You We give You thanks for Your great glory Lord God, heavenly king O God, almighty Father Lord Jesus Christ Only begotten Son Lord God, Lamb of God Son of the Father You take away the sins of the world Have mercy on us You take away the sins of the world Receive our prayer You are seated at the right hand of the Father Have mercy on us For You alone are the Holy One You alone are the Lord You alone are the Most High, Jesus Christ With the Holy Spirit In the glory of God, the Father Amen', 64, 'bot', '2023-02-22 16:09:16', 0, 0);
