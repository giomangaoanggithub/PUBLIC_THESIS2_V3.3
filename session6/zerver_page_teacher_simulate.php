...
if($matter == "0"){
    ...
    try {
        ...
        // set the PDO error mode to exception
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "INSERT INTO student_answers (answer, question_id, owner_student, time_of_submission, grades, checked) VALUES ('".$arr_answers."', '$question_id', 'bot', CURRENT_TIMESTAMP, '0', '0')";
